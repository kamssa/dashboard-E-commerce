...
public class Paiement extends AbstractEntity{
	...
	private final String cpm_designation="ACHAT D'ARTICLE(S)";
	...
	public String toString() {
		return "Paiement [apikey=" + apikey + ", cpm_amount=" + cpm_amount + ", cpm_currency=" + cpm_currency
				+ ", cpm_custom=" + cpm_custom + ", cpm_designation=" + cpm_designation + ", cpm_language="
				+ cpm_language + ", cpm_page_action=" + cpm_page_action + ", cpm_payment_config=" + cpm_payment_config
				+ ", cpm_site_id=" + cpm_site_id + ", cpm_trans_date=" + cpm_trans_date + ", cpm_trans_id="
				+ cpm_trans_id + ", cpm_version=" + cpm_version + ", signature=" + signature + ", payment_method="
				+ payment_method + ", cel_phone_num=" + cel_phone_num + ", cpm_phone_prefixe=" + cpm_phone_prefixe
				+ ", commande=" + commande + "]";
	}
